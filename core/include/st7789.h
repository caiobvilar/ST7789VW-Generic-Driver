...
void
st7789_fill_rect(st7789_t* lcd, uint16_t x, uint16_t y, uint16_t w, uint16_t h, uint16_t color); /* RGB565 */
void
st7789_fill_rect_rgb(st7789_t* lcd, uint16_t x, uint16_t y, uint16_t w, uint16_t h, uint8_t r, uint8_t g,
                     uint8_t b); /* RGB888 */

void
st7789_draw_pixels(st7789_t* lcd, uint16_t x, uint16_t y, uint16_t w, uint16_t h,
